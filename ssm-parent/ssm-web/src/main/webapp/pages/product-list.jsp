		...
		<div class="content-wrapper">
			...
			<div class="box box-primary">
				...
				<div class="box-body">
					...
					<div class="table-box">
								...
								<tr>
									...
									<td class="text-center">
										<button type="button" class="btn bg-olive btn-xs"
											onclick='location.href="/product/initUpdate?id=${product.id}"'>修改</button>
										<button type="button" class="btn bg-olive btn-xs"
						...
						<script type="text/javascript">
							function del(id) {
							    // 如果用户点击了【确认】confirm会返回true
								if(confirm("确认要删除此记录，一旦删除将无法恢复?")){
						...
						<div class="pull-left">
							<div class="form-group form-inline">
								<div class="btn-group">
									<button type="button" class="btn btn-default" title="新建"
										onclick='location.href="/product/initAdd"'>
										<i class="fa fa-file-o"></i> 新建
									</button>
									<button type="button" class="btn btn-default" title="删除"
										onclick='confirm("你确认要删除吗？")'>
				...
				<div class="box-footer">
					<div class="pull-left">
						<div class="form-group form-inline">
							当前${pageInfo.pageCode}页/共${pageInfo.totalPage}页，共${pageInfo.totalCount} 条数据。
