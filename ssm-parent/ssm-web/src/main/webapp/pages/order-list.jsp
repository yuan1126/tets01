				...
				<div class="box-body">
					...
					<div class="table-box">
						...
						<table id="dataList"
							...
							<tbody>
								<c:forEach items="${pageInfo.list}" var="od">
								<tr>
									<td><input name="ids" type="checkbox"></td>

									<td>${od.orderNum}</td>
									<td>${od.product.productName}</td>
									<td>${od.product.cityName}</td>
									<td>${od.product.departureTimeStr}</td>
									<td>${od.product.productPrice}</td>
									<td>${od.peopleCount}</td>
									<td><c:if test="${od.orderStatus == 0}">未支付</c:if>
										<c:if test="${od.orderStatus == 1}">已支付</c:if>
									</td>
									<td>
										<c:if test="${od.payType == 0}">支付宝</c:if>
										<c:if test="${od.payType == 1}">微信</c:if>
										<c:if test="${od.payType == 2}">其它</c:if>
									</td>
						...
						<div class="pull-left">
							<div class="form-group form-inline">
								<div class="btn-group">
									<button type="button" class="btn btn-default" title="新建"
										onclick='location.href="/orders/initAdd"'>
										<i class="fa fa-file-o"></i> 新建
									</button>
									<button type="button" class="btn btn-default" title="删除"
										onclick='confirm("你确认要删除吗？")'>
